		...
		for(int i=0;i<value.length();i++){
			...
			if(ch==symbol.charAt(0) && depth==0){
				...
				if(i>0){
					...
					if(previous.equals(MULTIPLICATION_LABEL ) || previous.equals(DIVISION_LABEL ) || previous.equals(POWER_LABEL ) || previous.equals(SUM_LABEL) || previous.equals(SUBTRACTION_LABEL) )
						continue;
				}
